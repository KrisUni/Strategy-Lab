...
CONFIGS = [
    ...
    (
        "ma_trend_with_ma_exit_long_aapl",
        {
            "trade_direction": "long_only",
            "entry_operator": "and",
            "exit_operator": "or",
    ...
    (
        "stoch_rsi_meanrevert_with_asym_exit_spy",
        {
            "trade_direction": "long_only",
            "entry_operator": "and",
            "exit_operator": "or",
            "stoch_rsi_entry_enabled": True,
            "stoch_rsi_length": 14,
            "stoch_rsi_k": 3,
            "stoch_rsi_d": 3,
    ...
    (
        "stoch_rsi_asym_exit_spy",
        {
            ...
            "stoch_rsi_overbought": 80,
            "stoch_rsi_exit_enabled": True,
            "stoch_rsi_exit_length": 21,
            "stoch_rsi_exit_k": 3,
            "stoch_rsi_exit_d": 3,
            "stoch_rsi_exit_overbought": 70,
            "stoch_rsi_exit_oversold": 30,
            "stop_loss_enabled": True,
            "stop_loss_pct_long": 4.0,
            "pamrp_enabled": False,
            "pamrp_exit_enabled": False,
